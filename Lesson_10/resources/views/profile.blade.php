...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Профиль пользователя ') . Auth::user()->name }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{route('profile') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control" name="name" value="{{ old('name') ?? $user->name }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $user->email }}" required autofocus>
                                    @if ($errors->has('email'))
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('Home') }}" role="button">{{ __('Отмена') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
